            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    <div class="col-md-8 col-md-offset-2" style="padding-bottom:10px;">
                        <a href="<?php echo base_url(); ?>pelanggaran_siswa_guru/input_pelanggaran/<?php echo $this->uri->segment('3'); ?>" class="btn btn-danger ">Tambahkan Pelanggaran</a>
                        <a href="<?php echo base_url(); ?>pelanggaran_siswa_guru/index" class="btn btn-danger ">Halaman Cari Siswa</a>
                    </div>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <?php
                                            if($ps->id_pelapor==$this->session->userdata('id_akun_guru') and $ps->level_pelapor=='guru'){
                                            ?>
