        ...
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                ...
                <form action="<?php echo base_url();?>/pelanggaran/tambah" method="post">
                <!-- Modal body -->
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_pelanggaran" required>
                                ...
                                <option value="<?php echo $jp->id_jenis_pelanggaran; ?>" ><?php echo $jp->nama_jenis_pelanggaran; ?></option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="email">Point:</label>
                            <input type="number" class="form-control" id="" name="point" required>
                        </div>
        ...
        <!-- modal tambah -->
         ...
         <div class="modal" id="modal_edit">
            <div class="modal-dialog">
                ...
                <form action="<?php echo base_url();?>/pelanggaran/edit" method="post">
                <!-- Modal body -->
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="email">Nama Pelanggaran:</label>
                            <input type="text" class="form-control" id="nama" name="nama" required>
                            <input type="hidden" class="form-control" id="id_pelanggaran" name="id_pelanggaran" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Jenis Pelanggaran:</label>
                            <select class="form-control" name="jenis_pelanggaran" id="jenis_pelanggaran" required>
                                <option>-- pilih jenis pelanggaran --</option>
                                <?php foreach($jenis_pelanggaran as $jp){ ?>
                                <option value="<?php echo $jp->id_jenis_pelanggaran; ?>" ><?php echo $jp->nama_jenis_pelanggaran; ?></option>
                                <?php }?>
...
// load data for edit
    $(document).ready(function() {
        $('.view_detail').click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url(); ?>pelanggaran/get_data_pelanggaran_edit",
                data:{id : id},
                method:'GET',
                dataType:'json',
                success:function(response) {
                $.each(response, function(i, item){
                    $('#id_pelanggaran').val(response[i].id_pelanggaran);
                    $('#nama').val(response[i].nama_pelanggaran);
                    $('#jenis_pelanggaran').val(response[i].id_jenis_pelanggaran);
                    $('#point').val(response[i].point_pelanggaran);
