        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>guru/index" class="waves-effect"><i class="fa fa-users fa-fw"
                                aria-hidden="true"></i>Guru</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Kelas/index" class="waves-effect"><i class="fa fa-map-signs fa-fw"
                                aria-hidden="true"></i>Kelas</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>jenis_Pelanggaran/index" class="waves-effect"><i class="fa fa-book fa-fw"
                                aria-hidden="true"></i>Jenis Pelanggaran</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>Pelanggaran/index" class="waves-effect"><i class="fa fa-book fa-fw"
                                aria-hidden="true"></i>Pelanggaran</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo base_url();?>laporan/index" class="waves-effect"><i class="fa fa-tags fa-fw"
